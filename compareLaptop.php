                    ...
                    <form method="POST" action="#">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="product-select" name="product-select">
                                <?php
                                $sql = "SELECT id, phone_model FROM phones WHERE category = 'laptop'";
                        ...
                        <br><button type="submit" class="buy-now">Submit</button>
                    </form>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-6">
                ...
                <section id="product-details">
                    ...
                    if (isset($_GET['id'])) {
                        ...
                        // Query the database for laptop information with the given id
           ...
           ON phones.id = reviews.product_id WHERE phones.id='$id' GROUP BY phones.id";
            ...
            <div class="col-md-6">
                <section id="compare-section">
                    ...
                    if (!isset($id)) {
                        $id = $id = rand(31, 40);
                        echo '<p class="error-message">Please select a device to view</p>';
                    }
...
<!-- End Product Details Section -->";
                        ...
                        echo "No laptop found with the given id.";
                    }
                    ?>
                </section>
