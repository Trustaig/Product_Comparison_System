                    ...
                    <div class="row">
                        <div class="col-md-auto">
                            <?php if (isset($_SESSION['user_id'])) { ?>
                                <a href="phones.php" class="btn-get-started">Continue Shopping</a>
                            <?php } else {
                                echo '<a class="btn-get-started" href="phones.php">Continue Shopping</a>';
                            } ?>
                        </div>
                    </div>
            </ol>
                    ...
                    <form method="POST" action="#">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="product-select" name="product-select">
                                ...
                                $sql = "SELECT id, phone_model FROM phones WHERE category ='phone'";
        ...
        <div class="row">
            <div class="col-md-6">
                <section id="product-details">
                    <?php
                    // Get the id of the phone to compare from the URL
                    if (isset($_GET['id'])) {
                        $id = $_GET['id'];

                        // Query the database for phone information with the given id, and its reviews
                        ...
                        // If no id found in URL(review button error handling)
                        echo "";
                    }
                    ?>
